...
public sealed class WebStateSerializerTests
{
    ...
    public void Serialize_PreservesNullFieldsRequiredByTypeScriptContract()
    {
        var model = new AppViewModel(
            ...
            new ProductViewModel("Календарь маркировки", "0.1.5", "Руслан Керусов", "KRS", "https://github.com/jadieify-hub/marking-calendar", "https://github.com/jadieify-hub/marking-calendar/blob/data/CHANGELOG.md", "https://pay.cloudtips.ru/p/53698013", "Независимый проект"),
            []);
