...
- встроенные товарные перечни трёх групп с поиском по понятному названию, ТН ВЭД и ОКПД 2;
...
Откройте `Справка` → `Товарные перечни` или нажмите «Какие товары входят» в подробностях события. Встроенный справочник содержит **товары для дома и интерьера, косметику/бытовую химию/личную гигиену и бакалею**. Группы доступны и тогда, когда в календаре ещё нет их событий. Просмотр справочника не меняет профиль и календарные фильтры.
...
![Товарные перечни](assets/screenshots/product-lists.png)
