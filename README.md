...
- встроенные товарные перечни четырёх групп с поиском по понятному названию, ТН ВЭД и ОКПД 2;
...
В подробностях события сразу показан блок «Какие товары входят»: названия, условия и исключения выбранной группы. Кнопка «Страница группы на ЧЗ» открывает официальный сайт даже у событий без своей ссылки. Общий поиск также доступен через `Справка` → `Товарные перечни`. Встроенный справочник содержит **товары для дома и интерьера, косметику/бытовую химию/личную гигиену, бакалею и детские игрушки**. Группы доступны и тогда, когда в календаре ещё нет их событий. Просмотр справочника не меняет профиль и календарные фильтры.
