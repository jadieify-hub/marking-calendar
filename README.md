...
Кнопки «Выбрать все» и «Снять все» над списком товарных групп меняют выбор сразу для всех групп, включая скрытые поиском. Выбор сохраняется в профиле.
...
```powershell
pwsh -File build/pack.ps1 -Version 0.1.16
